...
<html>
<head>
    <title>Leadership &#38; Communication Skills</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="navbar">
        ...
        <a class="active" href="leadership.php">Training Courses</a>
    ...
    $query_workshop_details = "SELECT * FROM training_workshop WHERE training_type_id = 1";
    $result = mysqli_query($conn, $query_workshop_details);
    $query_workshop_name = "SELECT * FROM training_type WHERE training_type_id = 1";
